...
file_path_as_absolute <- function(file) file
...
isSingleString <- function(x) typeof(x) == "character" && length(x) == 1
isSingleNumber <- function(x) is.numeric(x) && length(x) == 1
